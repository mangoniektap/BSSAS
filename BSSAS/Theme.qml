...
QtObject {
    ...
    readonly property color primaryLight: "#ECF2FA"
    readonly property color primaryLighter: "#F0F3FB"
    readonly property color primaryBorder: "#BBD8EE"
    readonly property color secondaryPressedBg: "#DCEEFF"

    readonly property color appBg: "#F9F9FB"
    readonly property color pageBg: "#F8FBFF"
    readonly property color contentBg: "#FCFCFD"
    readonly property color cardBg: "#F8F8FB"
