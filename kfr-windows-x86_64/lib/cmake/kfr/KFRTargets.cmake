...
foreach(_cmake_expected_target IN ITEMS kfr_dsp_sse2 kfr_dsp_sse41 kfr_dsp_avx kfr_dsp_avx2 kfr_dsp_avx512 kfr_dsp kfr_io kfr_audio kfr_dft_sse2 kfr_dft_sse41 kfr_dft_avx kfr_dft_avx2 kfr_dft_avx512 kfr_dft kfr_capi kfr)
...
set_target_properties(kfr_dsp_sse2 PROPERTIES
  INTERFACE_LINK_LIBRARIES "kfr;\$<LINK_ONLY:>"
)
...
set_target_properties(kfr_dsp PROPERTIES
  ...
  INTERFACE_LINK_OPTIONS "/WHOLEARCHIVE:\$<TARGET_FILE:kfr_dsp_sse2>"
)
...
# Create imported target kfr_audio
add_library(kfr_audio STATIC IMPORTED)

set_target_properties(kfr_audio PROPERTIES
  INTERFACE_LINK_LIBRARIES "kfr;kfr_io;kfr_dsp;mf;mfplat;mfreadwrite;mfuuid;propsys"
)
...
set_target_properties(kfr_dft PROPERTIES
  INTERFACE_LINK_LIBRARIES "kfr_dft_sse2;kfr_dft_sse41;kfr_dft_avx;kfr_dft_avx2;kfr_dft_avx512"
  INTERFACE_LINK_OPTIONS "/WHOLEARCHIVE:\$<TARGET_FILE:kfr_dft_sse2>"
)

# Create imported target kfr_capi
add_library(kfr_capi SHARED IMPORTED)
...
set_target_properties(kfr PROPERTIES
  ...
  INTERFACE_COMPILE_OPTIONS "\$<\$<CONFIG:DEBUG>:-DKFR_DEBUG>;-bigobj;\$<\$<CXX_COMPILER_ID:MSVC>:/Zc:lambda>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Load information for each installed configuration.
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/KFRTargets-*.cmake")
